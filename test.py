...
def multiperson(img, func, mode):
    ...
    for idx, i in enumerate(scales):
        ...
        res = (inp_res, inp_res)
        # transform images, transform matrix
        ...
        # tmp1,2 output from trained network
    ...
    # matching tags with tags. call group.py match_by_tag() function
...
def coco_eval(prefix, dt, gt):
    ...
    """
    # dt is prediction, gt is annotation
    # the COCO provides average precision(AP), AP across scales, AR, AR across scales mark
    ...
    widths = {}
    heights = {}
    # create two dictionary for each H, W information
    ...
    # create json file for annotations and predictions. and then using coco evaluation with its data provide.
    import json
